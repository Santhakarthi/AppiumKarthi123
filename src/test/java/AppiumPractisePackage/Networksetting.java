...
@Test
	public  void network() throws Throwable {
	...
	service.start();
        ...
        dc.setCapability("networkProfile", "2g-gprs-good");
        URL u=new URL("http://localhost:4723");
 		AndroidDriver driver=new AndroidDriver(u,dc);
 		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
 		//driver.sendSMS("+917558127361","Hi" );
 		//driver.makeGsmCall("+917558127361", GsmCallActions.CALL);
 		//driver.makeGsmCall("+917558127361",GsmCallActions.ACCEPT);
 		//driver.makeGsmCall("+917558127361",GsmCallActions.CANCEL);
	}
