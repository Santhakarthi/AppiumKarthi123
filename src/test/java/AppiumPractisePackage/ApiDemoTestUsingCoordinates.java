...
public class ApiDemoTestUsingCoordinates {
@Test
	public void coordinatesApiDemoTest() throws Throwable {
	...
	String a=driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text='Sample menu']")).getText();
	System.out.println(a);
		String b="Sample menu";
