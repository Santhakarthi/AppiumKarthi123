...
public class OpenAppTestUsingApiDemo {
@Test
	...
	service.start();
		...
		driver.findElement(AppiumBy.accessibilityId("Focus")).click();
		String a = driver.findElement(AppiumBy.accessibilityId("1. Vertical")).getText();
		String b="1. Vertical";
